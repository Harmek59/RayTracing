...
Texture2D::Texture2D(uint32_t width, uint32_t height, GLint internalformat, GLenum format, GLenum type, unsigned char *data){
    create();
...
void Texture2D::setTextureData(uint32_t width, uint32_t height, GLint internalformat, GLenum format, GLenum type, unsigned char *data){
    bind();
