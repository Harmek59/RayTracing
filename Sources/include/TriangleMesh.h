...
public:
	...
	static void bindBuffers(uint32_t trianglesBufferBinding, uint32_t verticesBufferBinding, uint32_t normalsBufferBinding, uint32_t textureCoordsBufferBinding);
