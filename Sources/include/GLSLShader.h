...
class GLSLShader{
public:
    GLSLShader(const std::string& vertexShaderPath, const std::string& fragmentShaderPath, const std::string& geometryShaderPath = "");

    GLSLShader(const std::string& vertexShaderPath, const std::string& fragmentShaderPath, const std::string& tessControlShaderPath, 
...
private:
    ...
    GLuint createAndCompileShader(const std::string& shaderCode, GLenum shaderType, const std::string& shaderName);    //return shader ID
